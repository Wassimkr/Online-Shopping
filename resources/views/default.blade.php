...
<html lang="en">
    ...
    $total = ProduitsController::cartItem();
    ?>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <ul class="header-dropdown">
                            ...
                            @if(Route::has('login'))
                            @auth
                            <li><a href="/cartList"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Shopping Cart ({{$total}})</a></li>
                            @endauth
                            @endif
                            <li class="onhover-dropdown mobile-account">
                                ...
                                <ul class="onhover-show-div">
                                    ...
                                    <li><a href="{{ route('register') }}" data-lng="es">Register</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                            ...
                            @if (Auth::user()->utype === 'ADM')
                                <div class="col-lg-6 text-right">
                                    <ul class="header-dropdown">
                                        ...
                                        <li><a href="/cartList"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Shopping Cart ({{$total}})</a></li>
                                        <li class="onhover-dropdown mobile-account">
                                            <i class="fa fa-user" aria-hidden="true"></i>Hi Admin {{Auth::user()->name}}
                                                <ul class="onhover-show-div">
                                                <li><a href="" data-lng="en">Profile</a></li>
                                                <li><a href="{{ route('logout')}}" data-lng="es" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                ...
                                <div class="col-lg-6 text-right">
                                    <ul class="header-dropdown">
                                        ...
                                        <li class="onhover-dropdown mobile-account">
                                            ...
                                            <ul class="onhover-show-div">
                                                <li><a href="" data-lng="en">Profile</a></li>
                                                <li><a href="{{ route('logout')}}" data-lng="es" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Déconnecter</a></li>
                                                <form id="logout-form" action="{{route('logout')}}" method="POST">
                                                    @csrf
                                                </form>
                                            </ul>
                                ...
                                <div id="mySidenav" class="sidenav">
                                    ...
                                    <nav>
                                        ...
                                        <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                                        ...
                                                        <div class="row m-0">
                                                            <div class="col-xl-4">
                                                                <div class="link-section">
                                                                    ...
                                                                    <ul>
                                                                        <li><a href="/categorie/1">dresses</a></li>
                                                                        <li><a href="/categorie/2">skirts</a></li>
                                                                        <li><a href="/categorie/3">ethic wear</a></li>
                                                                        <li><a href="/categorie/11">sport wear</a></li>
                                                                    </ul>
                                                                    <h5>men's fashion</h5>
                                                                    <ul>
                                                                        <li><a href="/categorie/13">sports wear</a></li>
                                                                        <li><a href="/categorie/12">classic wear</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="link-section">
                                                                    <h5>accessories</h5>
                                                                    <ul>
                                                                        <li><a href="/categorie/15">fashion jewellery</a></li>
                                                                        <li><a href="/categorie/14">caps and hats</a></li>
                                                                        <li><a href="/categorie/16">wrist wear</a></li>
                                                                        <li><a href="/categorie/17">ties</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <li> <a href="#">bags</a>
                                                <ul>
                                                    <li><a href="/categorie/18">shopper bags</a></li>
                                                    <li><a href="/categorie/19">laptop bags</a></li>
                                                    <li> <a href="/categorie/20">purses</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="/categorie/21">watches</a></li>
                                            <li> <a href="/categorie/22">makeup</a></li>
                                            <li><a href="/categorie/23">home & decor</a></li>
                                            <li><a href="/categorie/24">kitchen</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('categorie.show', $categorie->id) }}">
                                <div class="classic-effect">
                                    <div>
                                        <img src={{"/images/".$categorie->image}}
    ...
    <br><br><br>
    <!-- top boutique section end -->
    <br><br>

    <!-- Parallax banner -->
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../images/online.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                    ...
                    @foreach ($produits as $produits)
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src={{"/images/".$produits->image}}
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <form action="/add_to_cart" method="POST">
                                        @csrf
                                        <input type="hidden" name="produit_id" value={{ $produits->idProduit }}>
                                        <button data-toggle="modal" onclick="openCart()" data-target="#add-to-cart" title="Add to cart">
                                            <i class="ti-shopping-cart"></i>
                                        </button>
                                    </form>
                                    <a href="{{"/produit/".$produits->idProduit}}" data-toggle="modal" data-target="#quick-view" title="Quick View">
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            ...
                            <p>Visit us on our social media accounts to find out the good news</p>
                            <div class="footer-social">
                                <ul>
                                    <li><a href="https://www.facebook.com/wassim.khan.3114"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/wassim-kribaa-72369319a/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    <li><a href="/"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.instagram.com/wassimkribaa/?hl=fr"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                    ...
                    <div class="col offset-xl-1">
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul>
                                    <li><a href="/about"><p>How it works</p></a></li>
                                    <li><a href="/about"><p>Our enterprise</p></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul>
                                    <li><a href="/contact">Leave us a message</a></li>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    ...
                                    <li><i class="fa fa-phone"></i>+213 (0) 541 08 95 45</li>
                                    <li><i class="fa fa-envelope-o"></i>hw_kribaa@esi.dz</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> Copyright {{ date('Y') }} KRIBAA WASSIM - Tous les droits réservés</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
