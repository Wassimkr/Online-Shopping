...
<head>
    ...
    <title>Online-Shopping | Shopping Cart</title>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-dropdown">
                            <ul>
                                <li><a href="/">Bienvenue Dans Notre Market TEPYACH</a></li>
                            </ul>
                        </div>
                    </div>
                    @guest  
    ...
    <section class="cart-section section-b-space">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <table class="table cart-table table-responsive-xs">
                        ...
                        <p style="display: none;"> {{$tt = 0}} </p>
                        @foreach ($produits as $produits)
                        <tbody>
                            <tr>
                                <td>
                                    <a href="#"><img src={{"/images/".$produits->image}} alt=""></a>
                                </td>
                                <td><a href="#">{{ $produits->nom }}</a>
                                    <div class="mobile-cart-content row">
                                        ...
                                        <div class="col-xs-3">
                                            <h2 class="td-color">{{ $produits->prix }}$</h2>
                                        </div>
                                        <div class="col-xs-3">
                                ...
                                <td><a href="/deletec/{{$produits->cart_id}}" class="icon"><i class="ti-close"></i></a></td>
                            </tr>
                        </tbody>
                        <p style="display: none;"> {{$tt += $produits->prix}}; </p>
                        @endforeach
                    </table>
            ...
            <div class="row cart-buttons">
                ...
                <!--<div class="col-6"><a href="#" class="btn btn-solid">Buy Now</a></div>-->
            </div>
        </div>
    </section>
    <!--section end-->
