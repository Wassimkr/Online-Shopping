...
<head>
    ...
    <title>Online-Shopping | Categorie</title>
...
<body>
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account">
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="{{ route('login') }}" data-lng="en">Connexion</a></li>
                                    <li><a href="{{ route('register') }}" data-lng="es">Inscription</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>              
    ...
    <section class="section-b-space ratio_square bag-product">
        <div class="container">
            <div class="title2">
                <h4>Catégorie</h4>
                <h2 class="title-inner2">Produits</h2>
            </div>
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                                ...
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="product-box product-wrap">                                                                               
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                    <img alt="" src={{"/images/".$produits->image}} class="img-fluid blur-up lazyload bg-img">

                                            </div>
                                            <div class="cart-detail">
                                                <a href={{"/produit/".$produits->idProduit}}  title="Quick View">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <form action="/add_to_cart" method="POST">   
                                                <div class="add-btn">
                                                    ...
                                                    <button onclick="openCart()" class="btn btn-outline">
                ...
                <div class="row footer-theme partition-f">
                    ...
                    <div class="col">
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul>
                                    <li><a href="/contact">Laissez nous un message</a></li>
