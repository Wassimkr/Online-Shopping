...
<head>
    ...
    <title>Online-Shopping | Produit</title>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('categorie_path') }}">Categorie</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="product-slick">
                                            <div><img src={{"/images/".$product->image}} alt=""
                                    ...
                                    <div class="col-lg-6 rtl-text">
                                        <div class="product-right">
                                            ...
                                            <div class="product-description border-product">
                                                 ...
                                                 <h6 class="product-title">quantite</h6>
                                                <div class="qty-box">
