                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right"></i></a>
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a href="product-detail.html"><i class="fa fa-circle"></i>Category List</a></li>
                                </ul>
                    </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    <div class="col-xl-7">
                                        {!! Form::model($produits,['route' => ['produits.update',$produits->idProduit], 'method' => 'PUT', 'files' => true]) !!}
