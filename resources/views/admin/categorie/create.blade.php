                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    <div class="col-xl-7">
                                        {!! Form::open(['route' => 'categorie.create', 'method' => 'POST', 'files' => true, 'data-parsley-validate'=>'']) !!}
            <div class="form-group">
                {{ Form::label('nomc', 'Name') }}
                {{ Form::text('nomc', null, array('class' => 'form-control','required'=>'','minlength'=>'5')) }}
            </div>
