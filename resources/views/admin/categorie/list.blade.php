                        ...
                        <div class="card">
                            <div class="card-body product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="#"><img src={{"/images/".$categorie->image}} class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        <div class="product-hover">
                                            <ul>
                                                <li>
                                                    <form action="{{ url('/deletec/'.$categorie->id) }}" method="POST">
                                                        {{ method_field('DELETE')}}
                                                        {{ csrf_field() }}
